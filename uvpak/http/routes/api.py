...
class Api(Routes):
    ...
    def register(self, route: ApiRouter):
        ...
        route.controllers = 'uvpak.http.api'
        ...
        # ----------------------------------------------------------------------
        # route.controller('uvpak.http.controllers.some.other.Other')

        # Also, route.controller and route.include are aliases of each other, same thing.
        # route.include('uvpak.http.controllers.some.other2.Other2')
        ...
        # route.controllers = 'uvpak.http.controllers'

        # Looks for Class in uvpak.http.controllers.some.Some
        # route.controller('some')

        # Leading period means APPEND path to defined route.controllers
        # So this looks for uvpak.http.controllers.other3.Other3
        ...
        #     # prefix of /group1/* with route name uvpak.group1.*
        ...
        #         # Will be route names uvpak.group1.subgroup1.*
        ...
        # def group2():
        #     # Name will be uvpak.g2.ex0 instead of the auto named uvpak.group2.example0
