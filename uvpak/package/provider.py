...
class Uvpak(Provider, Cli):
    ...
    def register(self) -> None:
        ...
        self.configs([
            # Here self.name is your packages name (ie: uvpak).
            {'key': self.name, 'value': self.package_config},
            #{'key': self.name, 'module': 'uvpak.config.package.config'},

            # Example of how to override another packages config with your own.
            #{'key': 'uvicore.auth', 'module': 'uvpak.config.packages.auth.config'},
        ])
    ...
    def register_views(self) -> None:
        ...
        # Define view paths
        self.register_http_views(['uvpak.http.views'])

        # Define view composers - multiple calls to self.composers() are appended
        #self.register_http_view_composers('uvpak.http.composers.layout.Layout', 'uvpak/*')
        #self.register_http_view_composers('uvpak.http.composers.layout.Layout', ['uvpak/home', 'uvpak/about'])

        # You can also define view composers as a dict
        # self.register_http_view_composers({
        #     'uvpak.http.composers.layout.Layout': 'uvpak/*',
        #     'uvpak.http.composers.layout.Layout': ['uvpak/home', 'uvpak/about'],
        # })

        # Define public paths
        self.register_http_public(['uvpak.http.public'])

        # Define asset paths
        self.register_http_assets(['uvpak.http.public.assets'])
    ...
    def register_routes(self) -> None:
        ...
        self.register_http_web_routes(
            module='uvpak.http.routes.web.Web',
        ...
        self.register_http_api_routes(
            module='uvpak.http.routes.api.Api',
