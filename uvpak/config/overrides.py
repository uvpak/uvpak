...
overrides = {
    ...
    # 'uvicore.logging': {
    #     'provider': 'uvpak.overrides.services.logging.Logging',
    # },
    # --------------------------------------------------------------------------
    'providers': {
        #
    ...
    # 'uvicore.foundation.application.Application': 'uvpak.overrides.application.Application',
    #
    # Note about ModelRouter
    # This is the only class that must be completely re-implimented, extension is NOT allowed.
    # 'uvicore.http.routing.model_router.ModelRoute': 'uvpak.overrides.http.model_router.ModelRoute',
    # --------------------------------------------------------------------------
    'ioc_bindings': {
        #
    },
