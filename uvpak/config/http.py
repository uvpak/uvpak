...
api = {
    ...
    'openapi': {
        'title': env('OPENAPI_TITLE', 'Uvpak API Docs'),
        'path': '/openapi.json',
        'docs': {
            'path': '/docs',
            ...
            'js_url': '/assets/uvpak/js/swagger-ui-bundle.min.js',
            'css_url': '/assets/uvpak/css/swagger-dark-ui.css', # Dark
            #'css_url': '/assets/uvpak/css/swagger-ui.min.css', # Light
